    ...
    def control_callback(self):
       ...
       # Check track availablility, return if not present
        ...
        if time.time() < self.t_start + self.t_runtime :
            ...
            if total_cones<=3 or len(self.old_detected_blue_cones.markers)<1 or len(self.old_detected_yellow_cones.markers)<1 or len(self.current_waypoints)<1:
